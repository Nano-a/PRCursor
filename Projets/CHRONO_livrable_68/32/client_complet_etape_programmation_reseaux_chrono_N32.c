/*
 * Snapshot CHRONO N°32 — **`cmd_post`** / **`cmd_reply`** (**N°24–25**) ;
 * après acceptation groupe (**`ans 1`**), membres peuvent poster et répondre ; voir `extrait_scenario_post_reply.sh`.
 */

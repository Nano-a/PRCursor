/*
 * Snapshot CHRONO N°13–18 — basé sur le fichier complet du dossier **17**.
 * Dossier 18 : extrait_server_mcast_admin.c (admin, mcast ff0e + port, groupe_add_member).
 */
...
static int handle_new_group_tcp(int cfd, uint32_t uid, const unsigned char *body, size_t blen)
{
    ...
    /* N°17–18 extrait_server_mcast_admin.c */
    g->admin_id = uid;

    {
        ...
        /*
         * N°18 tableau : multidiffusion unique — aucun groupe existant avec le même
         * couple (IPv6 multicast, port).
         */
